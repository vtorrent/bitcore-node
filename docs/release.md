...
Binaries for vtorrentd are distributed for convenience and built deterministically with Gitian, signatures for vtorrentd are located at the [gitian.sigs](https://github.com/vtorrent/gitian.sigs) respository.
