...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for vtorrentd is necessary for this upgrade with the "reindex=1" bitcoin.conf option. \n' +
                 ...
                 'https://github.com/vtorrent/bitcore-node/blob/vtorrentd/docs/upgrade.md \n');
