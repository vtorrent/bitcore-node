...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.vtorrentd.height === 150) {
            node.services.vtorrentd.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.vtorrentd.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('vtorrentd/hashblock', function(data) {
        bus.unsubscribe('vtorrentd/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.vtorrentd.height;
      node.services.vtorrentd.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.vtorrentd.sendTransaction(tx.serialize(), function(err, hash) {
