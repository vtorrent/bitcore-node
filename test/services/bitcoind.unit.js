...
var readFileSync = sinon.stub().returns(fs.readFileSync(path.resolve(__dirname, '../data/vtorrent.conf')));
var BitcoinService = proxyquire('../../lib/services/vtorrentd', {
  fs: {
    readFileSync: readFileSync
  }
});
var defaultBitcoinConf = fs.readFileSync(path.resolve(__dirname, '../data/default.vtorrent.conf'), 'utf8');

describe('vTorrent Service', function() {
  ...
  describe('@constructor', function() {
    it('will create an instance', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      should.exist(vtorrentd);
    });
    it('will create an instance without `new`', function() {
      var vtorrentd = BitcoinService(baseConfig);
      should.exist(vtorrentd);
    });
    it('will init caches', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      should.exist(vtorrentd.utxosCache);
      should.exist(vtorrentd.txidsCache);
      should.exist(vtorrentd.balanceCache);
      should.exist(vtorrentd.summaryCache);
      should.exist(vtorrentd.transactionDetailedCache);

      should.exist(vtorrentd.transactionCache);
      should.exist(vtorrentd.rawTransactionCache);
      should.exist(vtorrentd.blockCache);
      should.exist(vtorrentd.rawBlockCache);
      should.exist(vtorrentd.blockHeaderCache);
      should.exist(vtorrentd.zmqKnownTransactions);
      should.exist(vtorrentd.zmqKnownBlocks);
      should.exist(vtorrentd.lastTip);
      should.exist(vtorrentd.lastTipTimeout);
    });
    it('will init clients', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.nodes.should.deep.equal([]);
      vtorrentd.nodesIndex.should.equal(0);
      vtorrentd.nodes.push({client: sinon.stub()});
      should.exist(vtorrentd.client);
    });
    it('will set subscriptions', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.subscriptions.should.deep.equal({
        address: {},
        rawtransaction: [],
        hashblock: []
      });
  ...
  describe('#_initDefaults', function() {
    it('will set transaction concurrency', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._initDefaults({transactionConcurrency: 10});
      vtorrentd.transactionConcurrency.should.equal(10);
      vtorrentd._initDefaults({});
      vtorrentd.transactionConcurrency.should.equal(5);
    });
  });
  ...
  describe('#getAPIMethods', function() {
    it('will return spec', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var methods = vtorrentd.getAPIMethods();
  ...
  describe('#getPublishEvents', function() {
    it('will return spec', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var events = vtorrentd.getPublishEvents();
      should.exist(events);
      events.length.should.equal(3);
      events[0].name.should.equal('vtorrentd/rawtransaction');
      events[0].scope.should.equal(vtorrentd);
      events[0].subscribe.should.be.a('function');
      events[0].unsubscribe.should.be.a('function');
      events[1].name.should.equal('vtorrentd/hashblock');
      events[1].scope.should.equal(vtorrentd);
      events[1].subscribe.should.be.a('function');
      events[1].unsubscribe.should.be.a('function');
      events[2].name.should.equal('vtorrentd/addresstxid');
      events[2].scope.should.equal(vtorrentd);
    ...
    it('will call subscribe/unsubscribe with correct args', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.subscribe = sinon.stub();
      vtorrentd.unsubscribe = sinon.stub();
      var events = vtorrentd.getPublishEvents();

      events[0].subscribe('test');
      vtorrentd.subscribe.args[0][0].should.equal('rawtransaction');
      vtorrentd.subscribe.args[0][1].should.equal('test');

      events[0].unsubscribe('test');
      vtorrentd.unsubscribe.args[0][0].should.equal('rawtransaction');
      vtorrentd.unsubscribe.args[0][1].should.equal('test');

      events[1].subscribe('test');
      vtorrentd.subscribe.args[1][0].should.equal('hashblock');
      vtorrentd.subscribe.args[1][1].should.equal('test');

      events[1].unsubscribe('test');
      vtorrentd.unsubscribe.args[1][0].should.equal('hashblock');
      vtorrentd.unsubscribe.args[1][1].should.equal('test');
    });
  });
  ...
  describe('#subscribe', function() {
    ...
    it('will push to subscriptions', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var emitter = {};
      vtorrentd.subscribe('hashblock', emitter);
      vtorrentd.subscriptions.hashblock[0].should.equal(emitter);

      var emitter2 = {};
      vtorrentd.subscribe('rawtransaction', emitter2);
      vtorrentd.subscriptions.rawtransaction[0].should.equal(emitter2);
    });
  });
  ...
  describe('#unsubscribe', function() {
    ...
    it('will remove item from subscriptions', function() {
      ...
      var emitter4 = {};
      var emitter5 = {};
      vtorrentd.subscribe('hashblock', emitter1);
      vtorrentd.subscribe('hashblock', emitter2);
      vtorrentd.subscribe('hashblock', emitter3);
      vtorrentd.subscribe('hashblock', emitter4);
      vtorrentd.subscribe('hashblock', emitter5);
      vtorrentd.subscriptions.hashblock.length.should.equal(5);

      vtorrentd.unsubscribe('hashblock', emitter3);
      vtorrentd.subscriptions.hashblock.length.should.equal(4);
      vtorrentd.subscriptions.hashblock[0].should.equal(emitter1);
      vtorrentd.subscriptions.hashblock[1].should.equal(emitter2);
      vtorrentd.subscriptions.hashblock[2].should.equal(emitter4);
      vtorrentd.subscriptions.hashblock[3].should.equal(emitter5);
    });
    it('will not remove item an already unsubscribed item', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var emitter1 = {};
      var emitter3 = {};
      vtorrentd.subscriptions.hashblock= [emitter1];
      vtorrentd.unsubscribe('hashblock', emitter3);
      vtorrentd.subscriptions.hashblock.length.should.equal(1);
      vtorrentd.subscriptions.hashblock[0].should.equal(emitter1);
    });
  });
  ...
  describe('#subscribeAddress', function() {
    ...
    it('will not an invalid address', function() {
      ...
      vtorrentd.subscribeAddress(emitter, ['invalidaddress']);
      should.not.exist(vtorrentd.subscriptions.address['invalidaddress']);
    });
    it('will add a valid address', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var emitter = new EventEmitter();
      vtorrentd.subscribeAddress(emitter, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      should.exist(vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
    });
    it('will handle multiple address subscribers', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      vtorrentd.subscribeAddress(emitter1, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      vtorrentd.subscribeAddress(emitter2, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      should.exist(vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(2);
    });
    it('will not add the same emitter twice', function() {
      ...
      vtorrentd.subscribeAddress(emitter1, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      should.exist(vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddress', function() {
    ...
    it('it will remove a subscription', function() {
      ...
      should.exist(vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(2);
      vtorrentd.unsubscribeAddress(emitter1, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
    });
    it('will unsubscribe subscriptions for an emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter1, emitter2];
      vtorrentd.unsubscribeAddress(emitter1);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
    });
    it('will NOT unsubscribe subscription with missing address', function() {
      ...
      var emitter2 = new EventEmitter();
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter1, emitter2];
      vtorrentd.unsubscribeAddress(emitter1, ['1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo']);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(2);
    });
    it('will NOT unsubscribe subscription with missing emitter', function() {
      ...
      var emitter1 = new EventEmitter();
      var emitter2 = new EventEmitter();
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter2];
      vtorrentd.unsubscribeAddress(emitter1, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'][0].should.equal(emitter2);
    });
    it('will remove empty addresses', function() {
      ...
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter1, emitter2];
      vtorrentd.unsubscribeAddress(emitter1, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      vtorrentd.unsubscribeAddress(emitter2, ['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
      should.not.exist(vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br']);
    });
    it('will unsubscribe emitter for all addresses', function() {
      ...
      var emitter2 = new EventEmitter();
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter1, emitter2];
      vtorrentd.subscriptions.address['1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo'] = [emitter1, emitter2];
      sinon.spy(vtorrentd, 'unsubscribeAddressAll');
      vtorrentd.unsubscribeAddress(emitter1);
      vtorrentd.unsubscribeAddressAll.callCount.should.equal(1);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
      vtorrentd.subscriptions.address['1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo'].length.should.equal(1);
    });
  });
  ...
  describe('#unsubscribeAddressAll', function() {
    ...
    it('will unsubscribe emitter for all addresses', function() {
      ...
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'] = [emitter1, emitter2];
      vtorrentd.subscriptions.address['1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo'] = [emitter1, emitter2];
      vtorrentd.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'] = [emitter2];
      vtorrentd.subscriptions.address['3CMNFxN1oHBc4R1EpboAL5yzHGgE611Xou'] = [emitter1];
      vtorrentd.unsubscribeAddress(emitter1);
      vtorrentd.subscriptions.address['2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br'].length.should.equal(1);
      vtorrentd.subscriptions.address['1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo'].length.should.equal(1);
      vtorrentd.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'].length.should.equal(1);
      should.not.exist(vtorrentd.subscriptions.address['3CMNFxN1oHBc4R1EpboAL5yzHGgE611Xou']);
    });
  });
  ...
  describe('#_getDefaultConfig', function() {
    it('will generate config file from defaults', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var config = vtorrentd._getDefaultConfig();
  ...
  describe('#_loadSpawnConfiguration', function() {
    ...
    it('will parse a bitcoin.conf file', function() {
      var TestBitcoin = proxyquire('../../lib/services/vtorrentd', {
        fs: {
          readFileSync: readFileSync,
      ...
      var vtorrentd = new TestBitcoin(baseConfig);
      vtorrentd.options.spawn.datadir = '/tmp/.vtorrent';
      var node = {};
      vtorrentd._loadSpawnConfiguration(node);
      should.exist(vtorrentd.spawn.config);
      vtorrentd.spawn.config.should.deep.equal({
        addressindex: 1,
        checkblocks: 144,
        dbcache: 8192,
    ...
    it('will expand relative datadir to absolute path', function() {
      ...
      var vtorrentd = new TestBitcoin(config);
      vtorrentd.options.spawn.datadir = './data';
      var node = {};
      vtorrentd._loadSpawnConfiguration(node);
      vtorrentd.options.spawn.datadir.should.equal('/tmp/.bitcore/data');
    });
    it('should throw an exception if txindex isn\'t enabled in the configuration', function() {
      ...
      var vtorrentd = new TestBitcoin(baseConfig);
      (function() {
        vtorrentd._loadSpawnConfiguration({datadir: './test'});
  ...
  describe('#_checkConfigIndexes', function() {
    ...
    it('should warn the user if reindex is set to 1 in the bitcoin.conf file', function() {
      ...
      var node = {};
      vtorrentd._checkConfigIndexes(config, node);
  ...
  describe('#_resetCaches', function() {
    it('will reset LRU caches', function() {
      ...
      for (var i = 0; i < 10; i++) {
        ...
        vtorrentd.transactionDetailedCache.set(keys[i], {});
        vtorrentd.utxosCache.set(keys[i], {});
        vtorrentd.txidsCache.set(keys[i], {});
        vtorrentd.balanceCache.set(keys[i], {});
        vtorrentd.summaryCache.set(keys[i], {});
      }
      vtorrentd._resetCaches();
      should.equal(vtorrentd.transactionDetailedCache.get(keys[0]), undefined);
      should.equal(vtorrentd.utxosCache.get(keys[0]), undefined);
      should.equal(vtorrentd.txidsCache.get(keys[0]), undefined);
      should.equal(vtorrentd.balanceCache.get(keys[0]), undefined);
      should.equal(vtorrentd.summaryCache.get(keys[0]), undefined);
    });
  });
  ...
  describe('#_tryAllClients', function() {
    it('will retry for each node client', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.tryAllInterval = 1;
      vtorrentd.nodes.push({
        client: {
      ...
      vtorrentd._tryAllClients(function(client, next) {
        client.getInfo(next);
      }, function(err) {
        if (err) {
          return done(err);
        }
        vtorrentd.nodes[0].client.getInfo.callCount.should.equal(1);
        vtorrentd.nodes[1].client.getInfo.callCount.should.equal(1);
        vtorrentd.nodes[2].client.getInfo.callCount.should.equal(1);
        done();
      });
    });
    it('will start using the current node index (round-robin)', function(done) {
      ...
      vtorrentd._tryAllClients(function(client, next) {
        ...
        vtorrentd.nodes[1].client.getInfo.callCount.should.equal(1);
        vtorrentd.nodes[2].client.getInfo.callCount.should.equal(1);
        vtorrentd.nodesIndex.should.equal(2);
        done();
      });
    });
  ...
  describe('#_wrapRPCError', function() {
    it('will convert bitcoind-rpc error object into JavaScript error', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var error = vtorrentd._wrapRPCError({message: 'Test error', code: -1});
  ...
  describe('#_initChain', function() {
    ...
    it('will set height and genesis buffer', function(done) {
      ...
      vtorrentd.getRawBlock = sinon.stub().callsArgWith(1, null, genesisBuffer);
      vtorrentd.nodes.push({
        client: {
      ...
      vtorrentd._initChain(function() {
        log.info.callCount.should.equal(1);
        vtorrentd.getRawBlock.callCount.should.equal(1);
        vtorrentd.getRawBlock.args[0][0].should.equal('genesishash');
        vtorrentd.height.should.equal(5000);
        vtorrentd.genesisBuffer.should.equal(genesisBuffer);
        done();
      });
    });
    it('it will handle error from getBestBlockHash', function(done) {
      ...
      vtorrentd._initChain(function(err) {
        err.should.be.instanceOf(Error);
        done();
      });
    });
    ...
    it('it will handle error from getRawBlock', function(done) {
      ...
      vtorrentd.getRawBlock = sinon.stub().callsArgWith(1, new Error('test'));
      vtorrentd._initChain(function(err) {
        err.should.be.instanceOf(Error);
        done();
      });
  ...
  describe('#_getDefaultConf', function() {
    ...
    it('will get default rpc port for livenet', function() {
      ...
      var vtorrentd = new BitcoinService(config);
      vtorrentd._getDefaultConf().rpcport.should.equal(8332);
    });
    it('will get default rpc port for testnet', function() {
      ...
      var vtorrentd = new BitcoinService(config);
      vtorrentd._getDefaultConf().rpcport.should.equal(18332);
    });
  ...
  describe('#_getNetworkConfigPath', function() {
    ...
    it('will get default config path for livenet', function() {
      ...
      var vtorrentd = new BitcoinService(config);
      should.equal(vtorrentd._getNetworkConfigPath(), undefined);
    });
    it('will get default rpc port for testnet', function() {
      var config = {
        node: {
      ...
      var vtorrentd = new BitcoinService(config);
      vtorrentd._getNetworkConfigPath().should.equal('testnet3/bitcoin.conf');
    });
    it('will get default rpc port for regtest', function() {
      bitcore.Networks.enableRegtest();
      var config = {
      ...
      var vtorrentd = new BitcoinService(config);
      vtorrentd._getNetworkConfigPath().should.equal('regtest/bitcoin.conf');
    });
  });
  ...
  describe('#_getNetworkOption', function() {
    ...
    it('return --testnet for testnet', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.node.network = bitcore.Networks.testnet;
      vtorrentd._getNetworkOption().should.equal('--testnet');
    });
    it('return --regtest for testnet', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.node.network = bitcore.Networks.testnet;
      bitcore.Networks.enableRegtest();
      vtorrentd._getNetworkOption().should.equal('--regtest');
    });
    it('return undefined for livenet', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.node.network = bitcore.Networks.livenet;
      bitcore.Networks.enableRegtest();
      should.equal(vtorrentd._getNetworkOption(), undefined);
    });
  });
  ...
  describe('#_zmqBlockHandler', function() {
    it('will emit block', function(done) {
      ...
      vtorrentd._rapidProtectedUpdateTip = sinon.stub();
      vtorrentd.on('block', function(block) {
        block.should.equal(message);
        done();
      });
      vtorrentd._zmqBlockHandler(node, message);
    });
    ...
    it('will call function to update tip', function() {
      ...
      vtorrentd._rapidProtectedUpdateTip = sinon.stub();
      vtorrentd._zmqBlockHandler(node, message);
      vtorrentd._rapidProtectedUpdateTip.callCount.should.equal(1);
      vtorrentd._rapidProtectedUpdateTip.args[0][0].should.equal(node);
      vtorrentd._rapidProtectedUpdateTip.args[0][1].should.equal(message);
    });
    it('will emit to subscribers', function(done) {
      ...
      vtorrentd._rapidProtectedUpdateTip = sinon.stub();
      var emitter = new EventEmitter();
      vtorrentd.subscriptions.hashblock.push(emitter);
      emitter.on('vtorrentd/hashblock', function(blockHash) {
  ...
  describe('#_rapidProtectedUpdateTip', function() {
    it('will limit tip updates with rapid calls', function(done) {
      ...
      var count = 0;
      function repeat() {
        vtorrentd._rapidProtectedUpdateTip(node, message);
        count++;
        if (count < 50) {
          repeat();
        }
  ...
  describe('#_updateTip', function() {
    ...
    it('log and emit rpc error from get block', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub();
      vtorrentd.on('error', function(err) {
      ...
      vtorrentd._updateTip(node, message);
    });
    it('emit synced if percentage is 100', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, null, 100);
      vtorrentd.on('synced', function() {
        done();
      });
      var node = {
        client: {
    ...
    it('NOT emit synced if percentage is less than 100', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, null, 99);
      vtorrentd.on('synced', function() {
    ...
    it('log and emit error from syncPercentage', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, new Error('test'));
      vtorrentd.on('error', function(err) {
        log.error.callCount.should.equal(1);
        err.message.should.equal('test');
        done();
    ...
    it('reset caches and set height', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub();
      vtorrentd._resetCaches = sinon.stub();
      vtorrentd.on('tip', function(height) {
        vtorrentd._resetCaches.callCount.should.equal(1);
        height.should.equal(10);
        vtorrentd.height.should.equal(10);
        done();
      });
      var node = {
        client: {
    ...
    it('will not call syncPercentage if node is stopping', function(done) {
      ...
      vtorrentd.on('tip', function() {
        vtorrentd.syncPercentage.callCount.should.equal(0);
        done();
      });
      vtorrentd._updateTip(node, message);
    });
  ...
  describe('#_getAddressesFromTransaction', function() {
    it('will get results using bitcore.Transaction', function() {
      ...
      tx.sign(privkey);
      var addresses = vtorrentd._getAddressesFromTransaction(tx);
  ...
  describe('#_notifyAddressTxidSubscribers', function() {
    it('will emit event if matching addresses', function(done) {
      ...
      vtorrentd._getAddressesFromTransaction = sinon.stub().returns([address]);
      var emitter = new EventEmitter();
      vtorrentd.subscriptions.address[address] = [emitter];
      var txid = '46f24e0c274fc07708b781963576c4c5d5625d926dbb0a17fa865dcd9fe58ea0';
      var transaction = {};
      emitter.on('vtorrentd/addresstxid', function(data) {
        data.address.should.equal(address);
        data.txid.should.equal(txid);
        done();
      });
      sinon.spy(emitter, 'emit');
      vtorrentd._notifyAddressTxidSubscribers(txid, transaction);
  ...
  describe('#_zmqTransactionHandler', function() {
    it('will emit to subscribers', function(done) {
      ...
      var emitter = new EventEmitter();
      vtorrentd.subscriptions.rawtransaction.push(emitter);
      emitter.on('vtorrentd/rawtransaction', function(hex) {
        hex.should.be.a('string');
        hex.should.equal(expectedBuffer.toString('hex'));
        done();
      });
      var node = {};
      vtorrentd._zmqTransactionHandler(node, expectedBuffer);
    });
    it('will NOT emit to subscribers more than once for the same tx', function(done) {
      ...
      var emitter = new EventEmitter();
      vtorrentd.subscriptions.rawtransaction.push(emitter);
      emitter.on('vtorrentd/rawtransaction', function() {
        done();
      });
      var node = {};
      vtorrentd._zmqTransactionHandler(node, expectedBuffer);
    ...
    it('will emit "tx" event', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      var expectedBuffer = new Buffer(txhex, 'hex');
      vtorrentd.on('tx', function(buffer) {
  ...
  describe('#_checkSyncedAndSubscribeZmqEvents', function() {
    ...
    it('log errors, update tip and subscribe to zmq events', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._updateTip = sinon.stub();
      vtorrentd._subscribeZmqEvents = sinon.stub();
      var blockEvents = 0;
      vtorrentd.on('block', function() {
        blockEvents++;
      });
      var getBestBlockHash = sinon.stub().callsArgWith(0, null, {
      ...
      vtorrentd._checkSyncedAndSubscribeZmqEvents(node);
      setTimeout(function() {
        log.error.callCount.should.equal(2);
        blockEvents.should.equal(11);
        vtorrentd._updateTip.callCount.should.equal(11);
        vtorrentd._subscribeZmqEvents.callCount.should.equal(1);
        done();
      }, 200);
    });
  ...
  describe('#_subscribeZmqEvents', function() {
    it('will call subscribe on zmq socket', function() {
      ...
      vtorrentd._subscribeZmqEvents(node);
    ...
    it('will call relevant handler for rawtx topics', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._zmqTransactionHandler = sinon.stub();
      var node = {
      ...
      node.zmqSubSocket.on('message', function() {
        vtorrentd._zmqTransactionHandler.callCount.should.equal(1);
        done();
      });
    ...
    it('will call relevant handler for hashblock topics', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._zmqBlockHandler = sinon.stub();
      var node = {
        zmqSubSocket: new EventEmitter()
      };
      node.zmqSubSocket.subscribe = sinon.stub();
      vtorrentd._subscribeZmqEvents(node);
      node.zmqSubSocket.on('message', function() {
        vtorrentd._zmqBlockHandler.callCount.should.equal(1);
        done();
      });
    ...
    it('will ignore unknown topic types', function(done) {
      ...
      vtorrentd._subscribeZmqEvents(node);
      node.zmqSubSocket.on('message', function() {
        vtorrentd._zmqBlockHandler.callCount.should.equal(0);
        vtorrentd._zmqTransactionHandler.callCount.should.equal(0);
        done();
      });
  ...
  describe('#_initZmqSubSocket', function() {
    it('will setup zmq socket', function() {
      ...
      var vtorrentd = new BitcoinService(baseConfig);
      var node = {};
      vtorrentd._initZmqSubSocket(node, 'url');
  ...
  describe('#_checkReindex', function() {
    ...
    it('give error from client getblockchaininfo', function(done) {
      ...
      vtorrentd._checkReindex(node, function(err) {
        should.exist(err);
    ...
    it('will wait until sync is 100 percent', function(done) {
      ...
      vtorrentd._checkReindex(node, function() {
  ...
  describe('#_loadTipFromNode', function() {
    ...
    it('will give rpc from client getbestblockhash', function(done) {
      ...
      vtorrentd._loadTipFromNode(node, function(err) {
        err.should.be.instanceof(Error);
    ...
    it('will set height and emit tip', function(done) {
      ...
      vtorrentd.on('tip', function(height) {
        ...
        vtorrentd.height.should.equal(100);
        done();
      });
      vtorrentd._loadTipFromNode(node, function(err) {
        if (err) {
  ...
  describe('#_stopSpawnedProcess', function() {
    ...
    it('it will kill process and resume', function(done) {
      ...
      var TestBitcoinService = proxyquire('../../lib/services/vtorrentd', {
        fs: {
          readFile: readFile
        }
      });
      var vtorrentd = new TestBitcoinService(baseConfig);
      vtorrentd.spawnStopTime = 1;
      vtorrentd._process = {};
      vtorrentd._process.kill = sinon.stub();
      vtorrentd._stopSpawnedBitcoin(function(err) {
        if (err) {
          return done(err);
        }
        vtorrentd._process.kill.callCount.should.equal(1);
        log.warn.callCount.should.equal(1);
        done();
      });
    });
    it('it will attempt to kill process and resume', function(done) {
      ...
      error2.code = 'ESRCH';
      vtorrentd._process.kill = sinon.stub().throws(error2);
      vtorrentd._stopSpawnedBitcoin(function(err) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_spawnChildProcess', function() {
    ...
    it('will give error from spawn config', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._loadSpawnConfiguration = sinon.stub();
      vtorrentd._loadSpawnConfiguration = sinon.stub().throws(new Error('test'));
      vtorrentd._spawnChildProcess(function(err) {
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give error from stopSpawnedBitcoin', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._loadSpawnConfiguration = sinon.stub();
      vtorrentd._stopSpawnedBitcoin = sinon.stub().callsArgWith(0, new Error('test'));
      vtorrentd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
        err.message.should.equal('test');
      });
    ...
    it('will exit spawn if shutdown', function() {
      ...
      var vtorrentd = new TestBitcoinService(config);
      vtorrentd.spawn = {};
      vtorrentd._loadSpawnConfiguration = sinon.stub();
      vtorrentd._stopSpawnedBitcoin = sinon.stub().callsArgWith(0, null);
      vtorrentd.node.stopping = true;
      vtorrentd._spawnChildProcess(function(err) {
        err.should.be.instanceOf(Error);
    ...
    it('will include network with spawn command and init zmq/rpc on node', function(done) {
      ...
      vtorrentd._loadSpawnConfiguration = sinon.stub();
      vtorrentd.spawn = {};
      vtorrentd.spawn.exec = 'testexec';
      vtorrentd.spawn.configPath = 'testdir/bitcoin.conf';
      vtorrentd.spawn.datadir = 'testdir';
      vtorrentd.spawn.config = {};
      vtorrentd.spawn.config.rpcport = 20001;
      vtorrentd.spawn.config.rpcuser = 'bitcoin';
      vtorrentd.spawn.config.rpcpassword = 'password';
      vtorrentd.spawn.config.zmqpubrawtx = 'tcp://127.0.0.1:30001';

      vtorrentd._loadTipFromNode = sinon.stub().callsArgWith(1, null);
      vtorrentd._initZmqSubSocket = sinon.stub();
      vtorrentd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      vtorrentd._checkReindex = sinon.stub().callsArgWith(1, null);
      vtorrentd._spawnChildProcess(function(err, node) {
        ...
        vtorrentd._loadTipFromNode.callCount.should.equal(1);
        vtorrentd._initZmqSubSocket.callCount.should.equal(1);
        should.exist(vtorrentd._initZmqSubSocket.args[0][0].client);
        vtorrentd._initZmqSubSocket.args[0][1].should.equal('tcp://127.0.0.1:30001');
        vtorrentd._checkSyncedAndSubscribeZmqEvents.callCount.should.equal(1);
        should.exist(vtorrentd._checkSyncedAndSubscribeZmqEvents.args[0][0].client);
        should.exist(node);
        should.exist(node.client);
        done();
      });
    });
    it('will respawn vtorrentd spawned process', function(done) {
      var process = new EventEmitter();
      var spawn = sinon.stub().returns(process);
      var TestBitcoinService = proxyquire('../../lib/services/vtorrentd', {
        fs: {
      ...
      vtorrentd._loadSpawnConfiguration = sinon.stub();
      vtorrentd.spawn = {};
      vtorrentd.spawn.exec = 'vtorrentd';
      vtorrentd.spawn.datadir = '/tmp/bitcoin';
      vtorrentd.spawn.configPath = '/tmp/vtorrent/bitcoin.conf';
      vtorrentd.spawn.config = {};
      vtorrentd.spawnRestartTime = 1;
      vtorrentd._loadTipFromNode = sinon.stub().callsArg(1);
      vtorrentd._initZmqSubSocket = sinon.stub();
      vtorrentd._checkReindex = sinon.stub().callsArg(1);
      vtorrentd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      vtorrentd._stopSpawnedBitcoin = sinon.stub().callsArg(0);
      sinon.spy(vtorrentd, '_spawnChildProcess');
      vtorrentd._spawnChildProcess(function(err) {
        if (err) {
          return done(err);
        }
        process.once('exit', function() {
          setTimeout(function() {
            vtorrentd._spawnChildProcess.callCount.should.equal(2);
            done();
          }, 5);
        });
        process.emit('exit', 1);
    ...
    it('will emit error during respawn', function(done) {
      ...
      vtorrentd._spawnChildProcess(function(err) {
        ...
        vtorrentd._spawnChildProcess = sinon.stub().callsArgWith(0, new Error('test'));
        vtorrentd.on('error', function(err) {
          err.should.be.instanceOf(Error);
          err.message.should.equal('test');
          done();
    ...
    it('will NOT respawn vtorrentd spawned process if shutting down', function(done) {
      var process = new EventEmitter();
      var spawn = sinon.stub().returns(process);
      var TestBitcoinService = proxyquire('../../lib/services/vtorrentd', {
        fs: {
      ...
      vtorrentd._spawnChildProcess(function(err) {
        ...
        process.once('exit', function() {
          setTimeout(function() {
            vtorrentd._spawnChildProcess.callCount.should.equal(1);
            done();
          }, 5);
        });
        process.emit('exit', 1);
    ...
    it('will give error after 60 retries', function(done) {
      ...
      var vtorrentd = new TestBitcoinService(baseConfig);
      vtorrentd.startRetryInterval = 1;
      vtorrentd._loadSpawnConfiguration = sinon.stub();
      vtorrentd.spawn = {};
      vtorrentd.spawn.exec = 'testexec';
      vtorrentd.spawn.configPath = 'testdir/bitcoin.conf';
      ...
      vtorrentd.spawn.config.rpcpassword = 'password';
      vtorrentd.spawn.config.zmqpubrawtx = 'tcp://127.0.0.1:30001';
      vtorrentd._loadTipFromNode = sinon.stub().callsArgWith(1, new Error('test'));
      vtorrentd._spawnChildProcess(function(err) {
        vtorrentd._loadTipFromNode.callCount.should.equal(60);
        err.should.be.instanceof(Error);
        done();
      });
    });
    it('will give error from check reindex', function(done) {
      ...
      vtorrentd._initZmqSubSocket = sinon.stub();
      vtorrentd._checkSyncedAndSubscribeZmqEvents = sinon.stub();
      vtorrentd._checkReindex = sinon.stub().callsArgWith(1, new Error('test'));
  ...
  describe('#_connectProcess', function() {
    it('will give error if connecting while shutting down', function(done) {
      ...
      var vtorrentd = new BitcoinService(config);
      vtorrentd.node.stopping = true;
      vtorrentd.startRetryInterval = 100;
      vtorrentd._loadTipFromNode = sinon.stub();
      vtorrentd._connectProcess({}, function(err) {
        err.should.be.instanceof(Error);
        err.message.should.match(/Stopping while trying to connect/);
        vtorrentd._loadTipFromNode.callCount.should.equal(0);
        done();
      });
    });
    it('will give error from loadTipFromNode after 60 retries', function(done) {
      ...
      vtorrentd.startRetryInterval = 1;
      var config = {};
      vtorrentd._connectProcess(config, function(err) {
        err.should.be.instanceof(Error);
        vtorrentd._loadTipFromNode.callCount.should.equal(60);
        done();
      });
    ...
    it('will init zmq/rpc on node', function(done) {
      ...
      vtorrentd._loadTipFromNode = sinon.stub().callsArgWith(1, null);
      var config = {};
      vtorrentd._connectProcess(config, function(err, node) {
        should.not.exist(err);
        vtorrentd._loadTipFromNode.callCount.should.equal(1);
        vtorrentd._initZmqSubSocket.callCount.should.equal(1);
        vtorrentd._loadTipFromNode.callCount.should.equal(1);
  ...
  describe('#start', function() {
    ...
    it('will give error from connectProcess', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._connectProcess = sinon.stub().callsArgWith(1, new Error('test'));
      vtorrentd.options = {
        connect: [
          {}
        ]
      ...
      vtorrentd.start(function(err) {
        vtorrentd._connectProcess.callCount.should.equal(1);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will push node from spawnChildProcess', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      var node = {};
      vtorrentd._initChain = sinon.stub().callsArg(0);
      vtorrentd._spawnChildProcess = sinon.stub().callsArgWith(0, null, node);
      vtorrentd.options = {
        spawn: {}
      };
      vtorrentd.start(function(err) {
        should.not.exist(err);
        vtorrentd.nodes.length.should.equal(1);
        done();
      });
    });
    it('will push node from connectProcess', function(done) {
      ...
      vtorrentd._initChain = sinon.stub().callsArg(0);
      var nodes = [{}];
      vtorrentd._connectProcess = sinon.stub().callsArgWith(1, null, nodes);
      vtorrentd.options = {
        connect: [
          {}
        ]
  ...
  describe('#isSynced', function() {
    it('will give error from syncPercentage', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, new Error('test'));
      vtorrentd.isSynced(function(err) {
        should.exist(err);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give "true" if percentage is 100.00', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, null, 100.00);
      vtorrentd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
    ...
    it('will give "true" if percentage is 99.98', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, null, 99.98);
      vtorrentd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
    ...
    it('will give "false" if percentage is 99.49', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, null, 99.49);
      vtorrentd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
    ...
    it('will give "false" if percentage is 1', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.syncPercentage = sinon.stub().callsArgWith(0, null, 1);
      vtorrentd.isSynced(function(err, synced) {
        if (err) {
          return done(err);
        }
  ...
  describe('#syncPercentage', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.syncPercentage(function(err) {
        should.exist(err);
    ...
    it('will call client getInfo and give result', function(done) {
      ...
      vtorrentd.syncPercentage(function(err, percentage) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_normalizeAddressArg', function() {
    it('will turn single address into array', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var args = vtorrentd._normalizeAddressArg('address');
      args.should.deep.equal(['address']);
    });
    it('will keep an array as an array', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var args = vtorrentd._normalizeAddressArg(['address', 'address']);
  ...
  describe('#getAddressBalance', function() {
    it('will give rpc error', function(done) {
      ...
      var address = '1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo';
      var options = {};
      vtorrentd.getAddressBalance(address, options, function(err) {
        err.should.be.instanceof(Error);
        done();
      });
    });
    it('will give balance', function(done) {
      ...
      var address = '1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo';
      var options = {};
      vtorrentd.getAddressBalance(address, options, function(err, data) {
        if (err) {
          return done(err);
        }
        data.balance.should.equal(10000);
        data.received.should.equal(100000);
        vtorrentd.getAddressBalance(address, options, function(err, data2) {
          if (err) {
            return done(err);
          }
  ...
  describe('#getAddressUnspentOutputs', function() {
    it('will give rpc error', function(done) {
      ...
      var address = '1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo';
      vtorrentd.getAddressUnspentOutputs(address, options, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will give results from client getaddressutxos', function(done) {
      ...
      var address = '1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo';
      vtorrentd.getAddressUnspentOutputs(address, options, function(err, utxos) {
        if (err) {
          return done(err);
        }
  ...
  describe('#_getBalanceFromMempool', function() {
    it('will sum satoshis', function() {
      ...
      var sum = vtorrentd._getBalanceFromMempool(deltas);
  ...
  describe('#_getTxidsFromMempool', function() {
    it('will filter to txids', function() {
      ...
      var txids = vtorrentd._getTxidsFromMempool(deltas);
  ...
  describe('#_getHeightRangeQuery', function() {
    it('will detect range query', function() {
      ...
      var rangeQuery = vtorrentd._getHeightRangeQuery(options);
    ...
    it('will get range properties', function() {
      ...
      var clone = {};
      vtorrentd._getHeightRangeQuery(options, clone);
    ...
    it('will throw error with invalid range', function() {
      ...
      (function() {
        vtorrentd._getHeightRangeQuery(options);
  ...
  describe('#getAddressTxids', function() {
    it('will give error from _getHeightRangeQuery', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._getHeightRangeQuery = sinon.stub().throws(new Error('test'));
      vtorrentd.getAddressTxids('address', {}, function(err) {
        err.should.be.instanceOf(Error);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give rpc error from mempool query', function() {
      ...
      var options = {};
      var address = '1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo';
      vtorrentd.getAddressTxids(address, options, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
      });
    });
    ...
    it('will get txid results', function(done) {
      ...
      var address = '1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo';
      vtorrentd.getAddressTxids(address, options, function(err, txids) {
        if (err) {
          return done(err);
        }
    ...
    it('will get txid results from cache and live mempool', function(done) {
      ...
      var address = '1Cj4UZWnGWAJH1CweTMgPLQMn26WRMfXmo';
      vtorrentd.getAddressTxids(address, {queryMempool: false}, function(err, txids) {
        if (err) {
          return done(err);
        }
        getAddressTxids.callCount.should.equal(1);
        ...
        vtorrentd.getAddressTxids(address, {queryMempool: true}, function(err, txids) {
          if (err) {
            return done(err);
          }
          getAddressTxids.callCount.should.equal(1);
          ...
          vtorrentd.getAddressTxids(address, {queryMempoolOnly: true}, function(err, txids) {
            if (err) {
              return done(err);
            }
            getAddressTxids.callCount.should.equal(1);
  ...
  describe('#_getConfirmationDetail', function() {
    ...
    it('should get 0 confirmation', function() {
      ...
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.height = 10;
      var confirmations = vtorrentd._getConfirmationsDetail(tx);
  ...
  describe('#_getAddressDetailsForInput', function() {
    it('will return if missing an address', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var result = {};
      vtorrentd._getAddressDetailsForInput({}, 0, result, []);
    ...
    it('will only add address if it matches', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var result = {};
      vtorrentd._getAddressDetailsForInput({
        address: 'address1'
      }, 0, result, ['address2']);
      should.not.exist(result.addresses);
      should.not.exist(result.satoshis);
  ...
  describe('#_getAddressDetailsForOutput', function() {
    it('will return if missing an address', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var result = {};
      vtorrentd._getAddressDetailsForOutput({}, 0, result, []);
      should.not.exist(result.addresses);
      should.not.exist(result.satoshis);
    });
    it('will only add address if it matches', function() {
      var vtorrentd = new BitcoinService(baseConfig);
      var result = {};
      vtorrentd._getAddressDetailsForOutput({
        address: 'address1'
      }, 0, result, ['address2']);
      should.not.exist(result.addresses);
      should.not.exist(result.satoshis);
  ...
  describe('#_getAddressDetailsForTransaction', function() {
    it('will calculate details for the transaction', function(done) {
      ...
      var details = vtorrentd._getAddressDetailsForTransaction(tx, addresses);
  ...
  describe('#_getAddressDetailedTransaction', function() {
    it('will get detailed transaction info', function(done) {
      ...
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.getDetailedTransaction = sinon.stub().callsArgWith(1, null, tx);
      vtorrentd.height = 300;
      var addresses = {};
      vtorrentd._getAddressDetailsForTransaction = sinon.stub().returns({
        addresses: addresses,
        satoshis: 1000,
      });
      vtorrentd._getAddressDetailedTransaction(txid, {}, function(err, details) {
        if (err) {
          return done(err);
        }
    ...
    it('give error from getDetailedTransaction', function(done) {
      var txid = '46f24e0c274fc07708b781963576c4c5d5625d926dbb0a17fa865dcd9fe58ea0';
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.getDetailedTransaction = sinon.stub().callsArgWith(1, new Error('test'));
      vtorrentd._getAddressDetailedTransaction(txid, {}, function(err) {
        err.should.be.instanceof(Error);
        done();
      });
    });
  ...
  describe('#_getAddressStrings', function() {
    it('will get address strings from bitcore addresses', function() {
      ...
      var vtorrentd = new BitcoinService(baseConfig);
      var strings = vtorrentd._getAddressStrings(addresses);
    ...
    it('will give error with unknown', function() {
      ...
      var vtorrentd = new BitcoinService(baseConfig);
      (function() {
        vtorrentd._getAddressStrings(addresses);
  ...
  describe('#getAddressHistory', function() {
    ...
    it('will give error with "from" and "to" range that exceeds max size', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.getAddressHistory(address, {from: 0, to: 51}, function(err) {
        should.exist(err);
    ...
    it('will give error with "from" and "to" order is reversed', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.getAddressTxids = sinon.stub().callsArgWith(2, null, []);
      vtorrentd.getAddressHistory(address, {from: 51, to: 0}, function(err) {
        should.exist(err);
        err.message.match(/^\"from/);
        done();
      });
    ...
    it('will give error from _getAddressDetailedTransaction', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.getAddressTxids = sinon.stub().callsArgWith(2, null, ['txid']);
      vtorrentd._getAddressDetailedTransaction = sinon.stub().callsArgWith(2, new Error('test'));
      vtorrentd.getAddressHistory(address, {}, function(err) {
        should.exist(err);
        err.message.should.equal('test');
        done();
      });
    ...
    it('will give an error if length of addresses is too long', function(done) {
      ...
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.maxAddressesQuery = 100;
      vtorrentd.getAddressHistory(addresses, {}, function(err) {
        should.exist(err);
    ...
    it('give error from getAddressTxids', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.getAddressTxids = sinon.stub().callsArgWith(2, new Error('test'));
      vtorrentd.getAddressHistory('address', {}, function(err) {
        should.exist(err);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
    ...
    it('will paginate', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._getAddressDetailedTransaction = function(txid, options, callback) {
        callback(null, txid);
      };
      var txids = ['one', 'two', 'three', 'four'];
      vtorrentd.getAddressTxids = sinon.stub().callsArgWith(2, null, txids);
      vtorrentd.getAddressHistory('address', {from: 1, to: 3}, function(err, data) {
        if (err) {
          return done(err);
        }
  ...
  describe('#getAddressSummary', function() {
    ...
    it('will handle error from getAddressTxids', function(done) {
      ...
      vtorrentd.getAddressTxids = sinon.stub().callsArgWith(2, new Error('test'));
      vtorrentd.getAddressBalance = sinon.stub().callsArgWith(2, null, {});
      var address = '';
      var options = {};
      vtorrentd.getAddressSummary(address, options, function(err) {
        should.exist(err);
        err.should.be.instanceof(Error);
        err.message.should.equal('test');
        done();
    ...
    it('will handle error from getAddressBalance', function(done) {
      ...
      vtorrentd.getAddressTxids = sinon.stub().callsArgWith(2, null, {});
      vtorrentd.getAddressBalance = sinon.stub().callsArgWith(2, new Error('test'), {});
      var address = '';
      var options = {};
      vtorrentd.getAddressSummary(address, options, function(err) {
        should.exist(err);
    ...
    it('should set all properties', function(done) {
      ...
      sinon.spy(vtorrentd, '_paginateTxids');
      vtorrentd.getAddressTxids = sinon.stub().callsArgWith(2, null, [txid1, txid2, txid3]);
      vtorrentd.getAddressBalance = sinon.stub().callsArgWith(2, null, {
        received: 30 * 1e8,
        balance: 20 * 1e8
      });
      ...
      var options = {};
      vtorrentd.getAddressSummary(address, options, function(err, summary) {
        vtorrentd._paginateTxids.callCount.should.equal(1);
        vtorrentd._paginateTxids.args[0][1].should.equal(0);
        vtorrentd._paginateTxids.args[0][2].should.equal(1000);
    ...
    it('will get from cache with noTxList', function(done) {
      ...
      vtorrentd.getAddressSummary(address, options, function(err, summary) {
        ...
        vtorrentd.getAddressTxids.callCount.should.equal(1);
        vtorrentd.getAddressBalance.callCount.should.equal(1);
        vtorrentd.getAddressSummary(address, options, function(err, summary) {
          checkSummary(summary);
          vtorrentd.getAddressTxids.callCount.should.equal(1);
          vtorrentd.getAddressBalance.callCount.should.equal(1);
    ...
    it('will skip querying the mempool with queryMempool set to false', function(done) {
      ...
      vtorrentd.getAddressSummary(address, options, function() {
        getAddressMempool.callCount.should.equal(0);
        done();
      });
    });
    it('will give error from _paginateTxids', function(done) {
      ...
      vtorrentd._paginateTxids = sinon.stub().throws(new Error('test'));
      var address = '3NbU8XzUgKyuCgYgZEKsBtUvkTm2r7Xgwj';
      var options = {
        queryMempool: false
      };
  ...
  describe('#getRawBlock', function() {
    ...
    it('will give rcp error from client getblockhash', function(done) {
      ...
      vtorrentd.getRawBlock(10, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will give rcp error from client getblock', function(done) {
      ...
      vtorrentd.getRawBlock(blockhash, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes for getblock', function(done) {
      ...
      vtorrentd.getRawBlock(blockhash, function(err, buffer) {
        if (err) {
          return done(err);
        }
        buffer.should.be.instanceof(Buffer);
    ...
    it('will get block by height', function(done) {
      ...
      vtorrentd.getRawBlock(0, function(err, buffer) {
        if (err) {
          return done(err);
        }
        buffer.should.be.instanceof(Buffer);
  ...
  describe('#getBlock', function() {
    ...
    it('will give an rpc error from client getblock', function(done) {
      ...
      vtorrentd.getBlock(0, function(err) {
        err.should.be.instanceof(Error);
        done();
      });
    });
    ...
    it('will getblock as bitcore object from height', function(done) {
      ...
      vtorrentd.getBlock(0, function(err, block) {
        should.not.exist(err);
    ...
    it('will getblock as bitcore object', function(done) {
      ...
      vtorrentd.getBlock('00000000050a6d07f583beba2d803296eb1e9d4980c4a20f206c584e89a4f02b', function(err, block) {
        should.not.exist(err);
    ...
    it('will get block from cache', function(done) {
      ...
      vtorrentd.getBlock(hash, function(err, block) {
        should.not.exist(err);
        getBlockHash.callCount.should.equal(0);
        getBlock.callCount.should.equal(1);
        block.should.be.instanceof(bitcore.Block);
  ...
  describe('#getBlockHashesByTimestamp', function() {
    it('should give an rpc error', function(done) {
      ...
      vtorrentd.getBlockHashesByTimestamp(1441911000, 1441914000, function(err, hashes) {
        should.exist(err);
    ...
    it('should get the correct block hashes', function(done) {
      ...
      vtorrentd.getBlockHashesByTimestamp(1441914000, 1441911000, function(err, hashes) {
        should.not.exist(err);
  ...
  describe('#getBlockHeader', function() {
    ...
    it('will give error from getBlockHash', function() {
      ...
      vtorrentd.getBlockHeader(10, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('it will give rpc error from client getblockheader', function() {
      ...
      vtorrentd.getBlockHeader(blockhash, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('it will give rpc error from client getblockhash', function() {
      ...
      vtorrentd.getBlockHeader(0, function(err) {
        err.should.be.instanceof(Error);
      });
    });
    it('will give result from client getblockheader (from height)', function() {
      ...
      vtorrentd.getBlockHeader(0, function(err, blockHeader) {
        should.not.exist(err);
    ...
    it('will give result from client getblockheader (from hash)', function() {
      ...
      vtorrentd.getBlockHeader(blockhash, function(err, blockHeader) {
        should.not.exist(err);
        getBlockHash.callCount.should.equal(0);
        blockHeader.should.deep.equal(result);
      });
  ...
  describe('#_maybeGetBlockHash', function() {
    it('will not get block hash with an address', function(done) {
      ...
      vtorrentd._maybeGetBlockHash('2N2JD6wb56AfK4tfmM6PwdVmoYk2dCKf4Br', function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
    ...
    it('will not get block hash with non zero-nine numeric string', function(done) {
      ...
      vtorrentd._maybeGetBlockHash('109a', function(err, hash) {
        if (err) {
          return done(err);
        }
        getBlockHash.callCount.should.equal(0);
    ...
    it('will get the block hash if argument is a number', function(done) {
      ...
      vtorrentd._maybeGetBlockHash(10, function(err, hash) {
        if (err) {
          return done(err);
        }
  ...
  describe('#getBlockOverview', function() {
    ...
    it('will handle error from maybeGetBlockHash', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd._maybeGetBlockHash = sinon.stub().callsArgWith(1, new Error('test'));
      vtorrentd.getBlockOverview(blockhash, function(err) {
        err.should.be.instanceOf(Error);
        done();
      });
    });
    ...
    it('will give expected result', function(done) {
      ...
      vtorrentd.getBlockOverview(blockhash, function(err, blockOverview) {
        if (err) {
          return done(err);
        }
  ...
  describe('#estimateFee', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.estimateFee(1, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client estimateFee and give result', function(done) {
      ...
      vtorrentd.estimateFee(1, function(err, feesPerKb) {
        if (err) {
          return done(err);
        }
  ...
  describe('#sendTransaction', function(done) {
    ...
    it('will give rpc error', function() {
      ...
      vtorrentd.sendTransaction(txhex, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
      });
    });
    it('will send to client and get hash', function() {
      ...
      vtorrentd.sendTransaction(txhex, function(err, hash) {
        if (err) {
          return done(err);
        }
    ...
    it('will send to client with absurd fees and get hash', function() {
      ...
      vtorrentd.sendTransaction(txhex, {allowAbsurdFees: true}, function(err, hash) {
        if (err) {
          return done(err);
        }
        hash.should.equal(tx.hash);
    ...
    it('missing callback will throw error', function() {
      ...
      var transaction = bitcore.Transaction();
      (function() {
        vtorrentd.sendTransaction(transaction);
      }).should.throw(Error);
    });
  });
  ...
  describe('#getRawTransaction', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.getRawTransaction('txid', function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes', function(done) {
      ...
      vtorrentd.getRawTransaction('txid', function(err, tx) {
        if (err) {
          return done(err);
        }
        should.exist(tx);
  ...
  describe('#getTransaction', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.getTransaction('txid', function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will try all nodes', function(done) {
      ...
      vtorrentd.getTransaction('txid', function(err, tx) {
        if (err) {
          return done(err);
        }
        should.exist(tx);
  ...
  describe('#getDetailedTransaction', function() {
    ...
    it('should give a transaction with height and timestamp', function(done) {
      ...
      vtorrentd.getDetailedTransaction(txid, function(err) {
        should.exist(err);
        err.should.be.instanceof(errors.RPCError);
        done();
      });
    ...
    it('should give a transaction with all properties', function(done) {
      ...
      vtorrentd.getDetailedTransaction(txid, function(err, tx) {
        if (err) {
          return done(err);
        }
        checkTx(tx);
  ...
  describe('#getBestBlockHash', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.getBestBlockHash(function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client getInfo and give result', function(done) {
      ...
      vtorrentd.getBestBlockHash(function(err, hash) {
        if (err) {
          return done(err);
        }
        should.exist(hash);
  ...
  describe('#getSpentInfo', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.getSpentInfo({}, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will empty object when not found', function(done) {
      ...
      vtorrentd.getSpentInfo({}, function(err, info) {
        should.not.exist(err);
  ...
  describe('#getInfo', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.getInfo(function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client getInfo and give result', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.node.getNetworkName = sinon.stub().returns('testnet');
      ...
      vtorrentd.getInfo(function(err, info) {
        if (err) {
          return done(err);
        }
        should.exist(info);
  ...
  describe('#generateBlock', function() {
    it('will give rpc error', function(done) {
      ...
      vtorrentd.generateBlock(10, function(err) {
        should.exist(err);
        err.should.be.an.instanceof(errors.RPCError);
        done();
      });
    ...
    it('will call client generate and give result', function(done) {
      ...
      vtorrentd.generateBlock(10, function(err, hashes) {
        if (err) {
          return done(err);
        }
  ...
  describe('#stop', function() {
    ...
    it('will exit spawned process', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.spawn = {};
      vtorrentd.spawn.process = new EventEmitter();
      vtorrentd.spawn.process.kill = sinon.stub();
      vtorrentd.stop(done);
      vtorrentd.spawn.process.kill.callCount.should.equal(1);
      vtorrentd.spawn.process.kill.args[0][0].should.equal('SIGINT');
      vtorrentd.spawn.process.emit('exit', 0);
    });
    it('will give error with non-zero exit status code', function(done) {
      ...
      vtorrentd.spawn.process.kill.callCount.should.equal(1);
      vtorrentd.spawn.process.kill.args[0][0].should.equal('SIGINT');
      vtorrentd.spawn.process.emit('exit', 1);
    });
    it('will stop after timeout', function(done) {
      var vtorrentd = new BitcoinService(baseConfig);
      vtorrentd.shutdownTimeout = 300;
      vtorrentd.spawn = {};
      vtorrentd.spawn.process = new EventEmitter();
      vtorrentd.spawn.process.kill = sinon.stub();
      vtorrentd.stop(function(err) {
